...
const HOMEPAGE_TABS = ['branding', 'hero_slides', 'ticker', 'why', 'features_head', 'features', 'pricing_section', 'how', 'trust', 'cta', 'footer', 'payment_logos'];
...
const FEATURES_PAGE_TABS = ['features_banner', 'feature_sections', 'features_cta'];
