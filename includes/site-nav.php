 ...
 */
$activeNav = $activeNav ?? '';
$langNext  = current_lang() === 'si' ? 'en' : 'si';
$langLabel = current_lang() === 'si' ? 'EN' : 'සිං';
$langAria  = current_lang() === 'si' ? 'Switch to English' : 'Switch to Sinhala';
?>
<div class="nav-fixed" id="navFixed">
  <nav class="navbar">
    ...
    <button class="nav-toggle" id="navToggle" aria-label="<?= e(t('Toggle navigation')) ?>">
    ...
    <div class="nav-actions">
      ...
      <a href="?lang=<?= e($langNext) ?>" class="nav-icon nav-lang" aria-label="<?= e($langAria) ?>"><?= e($langLabel) ?></a>
    </div>
  </nav>
</div>
