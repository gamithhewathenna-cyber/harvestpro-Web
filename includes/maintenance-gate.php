...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  body {
    ...
    background: #0f3d1e; color: #fff; font-family: "Helvetica Neue", Helvetica, Arial, sans-serif; text-align: center; padding: 24px;
  }
  .m-box { max-width: 480px; }
  .m-brand { font-family: "Helvetica Neue", Helvetica, Arial, sans-serif; font-weight: 600; font-size: 22px; margin-bottom: 28px; color: #f5b418; }
  h1 { font-family: "Helvetica Neue", Helvetica, Arial, sans-serif; font-weight: 300; font-size: 32px; margin-bottom: 14px; }
